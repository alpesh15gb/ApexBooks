...
def test_register_login_invoice_gstr_flow():
    reg=client.post('/api/v1/auth/register', json={
        'email':'admin@example.com','password':'secret123','full_name':'Admin',
        'company':{'company_name':'Apex Books','gstin':'27ABCDE1234F1Z5','pan':'ABCDE1234F','state_code':'27','address':{'line1':'x','city':'Mumbai','pincode':'400001','state_code':'27'},'business_type':'Pvt Ltd','registration_type':'Regular'}
    })
